export const personalPresentationOptions = [
...
export const knowledgeOptions = [
  ...
  { value: 3, label: "Às vezes lhe faltam conhecimentos sobre o trabalho." },
...
export const interpersonalRelationshipsOptions = [
...
export const punctualityOptions = [
